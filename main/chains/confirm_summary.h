...
#define CHAIN_CONFIRM_MAX_TEXT 96
...
typedef enum {
    ...
    CHAIN_CONFIRM_FIELD_SAFE_TX_GAS,
    CHAIN_CONFIRM_FIELD_BASE_GAS,
    CHAIN_CONFIRM_FIELD_GAS_PRICE,
