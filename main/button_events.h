...
typedef enum {
    ...
    BTN_NEW_MNEMONIC_12,
    BTN_NEW_MNEMONIC_24,
    BTN_NEW_MNEMONIC_STANDARD,
    BTN_NEW_MNEMONIC_ENHANCED,
    BTN_NEW_MNEMONIC_DICE_50,
    BTN_NEW_MNEMONIC_DICE_99,
    ...
    BTN_SETTINGS_INFO_USB_TRACE,
    BTN_SETTINGS_INFO_USB_HISTORY,
    BTN_SETTINGS_INFO_USB_CLEAR,
