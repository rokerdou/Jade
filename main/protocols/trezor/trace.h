...
#define TREZOR_TRACE_FORMATTED_LEN 2048
...
void trezor_trace_set_note(const char* fmt, ...);
void trezor_trace_checkpoint(const char* stage, const char* fmt, ...);
void trezor_trace_set_crash_stage(const char* stage);
